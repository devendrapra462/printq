...
function App() {
  ...
  useEffect(() => {
    ...
    styleSheet.innerText = `
      ...
      .stat-num { font-family: 'Oswald', sans-serif; font-size: 2.2rem; color: #e6522b; line-height: 1; font-weight: 700; word-break: break-all; }
  ...
  return (
    ...
    >
      ...
      {/* 1. TOP NAVBAR */}
      <header style={{ width: '100%', borderBottom: '1px solid #000000', padding: '20px 20px', boxSizing: 'border-box', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <span style={{ fontFamily: 'Oswald', fontSize: '0.9rem', letterSpacing: '0.05em', textTransform: 'uppercase', color: '#706b64' }}>
          DEVELOPER HUB
        </span>
      </header>
      ...
      <div className="grid-container">
        ...
        <div className="grid-left">
          <div>
            ...
            <p style={{ color: '#57534e', fontSize: '1.05rem', marginTop: '20px', maxWidth: '400px', lineHeight: '1.5', fontWeight: '500' }}>
        ...
        <div className="grid-right">
          ...
          {/* QR GATEWAY BOX */}
          <div style={{ flex: '1', padding: '30px 20px', borderBottom: '1px solid #000000', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', minHeight: '260px', boxSizing: 'border-box' }}>
            {isCustomer ? (
              <div style={{ textAlign: 'center' }}>
                <h2 className="outline-drop-text">READY</h2>
                <p style={{ fontFamily: 'Oswald', fontSize: '1.2rem', color: '#706b64', margin: '10px 0 0 0' }}>TERMINAL PIPE CONNECTED</p>
              </div>
            ) : (
              <div style={{ display: 'flex', flexWrap: 'wrap', width: '100%', alignItems: 'center', justifyContent: 'center', gap: '30px' }}>
          ...
          {/* FILE QUEUE */}
          <div className="custom-scroll" style={{ flex: '1', padding: '20px', overflowY: 'auto', maxHeight: '280px', boxSizing: 'border-box' }}>
            {receivedFiles.length === 0 ? (
              <div style={{ display: 'flex', height: '100%', minHeight: '100px', alignItems: 'center', justifyContent: 'center', color: '#706b64', fontFamily: 'Oswald', fontSize: '1.1rem', letterSpacing: '0.05em', textAlign: 'center' }}>
                AWAITING DATA TRANSMISSION FLOW...
              </div>
            ) : (
              receivedFiles.map((file, index) => (
                <div key={index} style={{ border: '1px solid #000000', padding: '14px 16px', backgroundColor: '#ffffff', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', boxShadow: '3px 3px 0px #000000', boxSizing: 'border-box' }}>
                  <div style={{ overflow: 'hidden', marginRight: '10px' }}>
                    <p style={{ margin: '0 0 4px 0', fontWeight: '700', fontSize: '1rem', color: '#000000', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }}>{file.fileName}</p>
                  ...
                  <div style={{ display: 'flex', gap: '6px', flexShrink: 0 }}>
                    <button onClick={() => triggerDirectPrint(file.fileData, file.fileName)} style={{ background: '#000000', color: '#ffffff', border: 'none', padding: '8px 14px', fontFamily: 'Oswald', cursor: 'pointer', fontSize: '0.9rem' }}>PRINT</button>
                    <button onClick={() => triggerManualDownload(file.fileData, file.fileName)} style={{ background: 'transparent', color: '#000000', border: '1px solid #000000', padding: '8px 10px', cursor: 'pointer', fontSize: '0.9rem' }}>⬇</button>
                  </div>
                </div>
              ))
            )}
      ...
      <div style={{ padding: '25px 20px', boxSizing: 'border-box' }}>
        {!isCustomer && (
          <div style={{ marginBottom: '25px' }}>
            ...
            <form onSubmit={handleRejoin} style={{ display: 'flex', maxWidth: '100%' }}>
              <input 
                type="text" 
                ...
                style={{ flex: '1', padding: '12px', border: '1px solid #000000', background: 'transparent', fontSize: '1rem', fontFamily: 'monospace', color: '#000000', minWidth: '0' }} 
              />
              <button type="submit" style={{ background: '#000000', color: '#ffffff', border: 'none', padding: '0 20px', fontFamily: 'Oswald', cursor: 'pointer', flexShrink: 0 }}>REJOIN</button>
            </form>
          </div>
        )}
